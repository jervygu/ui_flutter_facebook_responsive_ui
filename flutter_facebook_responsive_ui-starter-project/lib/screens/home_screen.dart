...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      // when in mobile, when you click a textfield, top anywhere on the screen to get rid of it
      child: Scaffold(
        body: Responsive(
          mobile:
      ...
      slivers: [
        SliverAppBar(
          ...
          actions: [
            ...
            //   ),
            //   child: IconButton(onPressed: () => debugPrint("tapped"), icon: Icon(Icons.search),
            //     iconSize: 30.0,
            //     color: Colors.black,
            //
            //   ),
